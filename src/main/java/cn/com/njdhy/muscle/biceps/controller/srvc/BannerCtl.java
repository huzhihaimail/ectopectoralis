...
public class BannerCtl {
    ...
    public Result insert(@RequestBody SrvcBanner srvcBanner) {
        ...
        try {
            ...
            return Result.error(BannerErrorCode.SYS_USER_SAVE_APP_ERROR_CODE, BannerErrorCode.SYS_USER_SAVE_APP_ERROR_MESSAGE);
        } catch (Exception e) {
            e.printStackTrace();
            return Result.error(BannerErrorCode.SYS_USER_SAVE_ERROR_CODE, BannerErrorCode.SYS_USER_SAVE_ERROR_MESSAGE);
        }
